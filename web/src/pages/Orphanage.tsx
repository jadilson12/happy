...
export default function Orphanage() {
  ...
  const [actiImageIndex, setActiImageIndex] = useState(0);
    ...
    <div id="page-orphanage">
      ...
      <main>
        <div className="orphanage-details">
          <img src={orphanage.images[actiImageIndex].url} alt={orphanage.name} />

          <div className="images">
            {orphanage.images.map((image, index) => (
              <button
                key={image.id}
                className={actiImageIndex === index ? 'active' : ''}
                onClick={() => setActiImageIndex(index)}
                type="button"
              >
